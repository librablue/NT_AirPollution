<template>
	<vxe-modal title="申請案件審核" v-model="visible" width="40%" :lock-scroll="false" esc-closable resize show-footer>
		<template #default>
			<el-form ref="form" :model="form">
				...
				<el-form-item v-if="form.FormStatus === 4" prop="CalcStatus" label="結算進度">
					<el-row type="flex">
						<el-col :span="12">
