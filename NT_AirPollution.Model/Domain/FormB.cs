...
namespace NT_AirPollution.Model.Domain
{
    ...
    public class FormB
    {
        ...
        /// <summary>管制編號</summary>
        public string C_NO { get; set; }

        /// <summary>序號</summary>
        public int? SER_NO { get; set; }

        /// <summary>結算申請日期</summary>
        public string AP_DATE1 { get; set; }

        /// <summary>結算狀態</summary>
        public string B_STAT { get; set; }

        /// <summary>施工狀態</summary>
        public string B_CSTAT { get; set; }

        /// <summary>工程類別代碼</summary>
        public string KIND_NO { get; set; }

        /// <summary>工程類別</summary>
        public string KIND { get; set; }

        /// <summary>費率年度</summary>
        public string YEAR { get; set; }

        /// <summary>工程費基種類</summary>
        ...
        /// <summary>未補繳原因</summary>
        public string REASON1 { get; set; }

        /// <summary>備註</summary>
        public string OPINION { get; set; }

        /// <summary>是否漏報短報</summary>
        public string WRONG_AP { get; set; }

        /// <summary>資料異動職工編號</summary>
